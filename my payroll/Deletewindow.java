    			...
    			public void paint(Graphics g)
    				{
    				   ...
    				   g.setFont(new Font("Cooper Black",Font.BOLD,40));
    					g.drawString("DELETE EMPLOYEE",60,70);
    				}
              ...
              try
              {
			    ...
			    sEmp_Code = TxtEmp_Code.getText().trim();	
                         ...
                         if ( !sEmp_Code.equals(""))
                         {
                                   ...
                                   String query = "SELECT * FROM EMPLOYEE WHERE Emp_Code='" + sEmp_Code+"'";
                					ResultSet rss = stmt.executeQuery(query);rss.next();String code=rss.getString(3);
                                   ...
                                   int result = stmt.executeUpdate( temp );
               					 ...
               					 String temp2 = "DELETE from deductions " +
                                     " WHERE Emp_Name1= '" + code + "'";
                                    int result2 = stmt.executeUpdate( temp2 );				
